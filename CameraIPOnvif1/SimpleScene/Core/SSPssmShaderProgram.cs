...
namespace SimpleScene
{
	...
	public class SSPssmShaderProgram : SSShaderProgram, ISSPssmShaderProgram
    {
		...
		public SSPssmShaderProgram(string preprocessorDefs = null)
        {
            ...
            GL.Ext.ProgramParameter (m_programID, AssemblyProgramParameterArb.GeometryInputType, (int)All.Triangles);
            GL.Ext.ProgramParameter (m_programID, AssemblyProgramParameterArb.GeometryOutputType, (int)All.TriangleStrip);
            GL.Ext.ProgramParameter (m_programID, AssemblyProgramParameterArb.GeometryVerticesOut, 3 * SSParallelSplitShadowMap.c_numberOfSplits);
